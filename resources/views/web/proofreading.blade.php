...
<div class="container py-4">
    <div class="row align-items-center justify-content-center">
      ...
      <div class="col-md-6 mb-4 mb-md-0">
        <h2 class="fw-bold mb-3 text-success fs-1">Get proofreading done by a single step</h2>
      </div>
        ...
        <div class="card border-0 shadow-sm p-4" id="ver-form">
          <form>
            ...
            <div class="mb-3">
              ...
              <input type="file" id="doc" class="form-control" placeholder="Upload your doc">
            </div>
            <div class="mb-3">
